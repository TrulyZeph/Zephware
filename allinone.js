javascript:(function() {
    ...
    function checkPassword() {
        ...
        if (adminPasswords.includes(enteredPassword) || ownerpassword.includes(enteredPassword) || userPasswords.includes(enteredPassword)) {
            closePanel();
            loadZephPanel();
        } else {
    ...
    if (console.log("Successfully Loaded!", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Loaded!", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let p,
        ...
        _ = l("div", {
            ...
            id: "variables",
            innerHTML: `:root {--backgroundColor: ${c.data?.theme?.backgroundColor || "linear-gradient(135deg, #2C2A2A, #171212)"};--infoColor: ${c.data?.theme?.infoColor || "#9a49aa"};--cheatList: ${c.data?.theme?.cheatList || "linear-gradient(315deg, #038FF9, #00C5FF)"};--defaultButton: ${c.data?.theme?.defaultButton || "#0869FA"};--disabledButton: ${c.data?.theme?.disabledButton || "linear-gradient(315deg, hsla(212, 100%, 50%, 1) 0%, hsla(219, 100%, 50%, 1) 100%)"};--enabledButton: ${c.data?.theme?.enabledButton || "linear-gradient(315deg, hsla(185, 100%, 50%, 1) 0%, hsla(204, 100%, 50%, 1) 100%)"};--textColor: ${c.data?.theme?.textColor || "white"};--inputColor: ${c.data?.theme?.inputColor || "#0861FA"};--contentBackground: ${c.data?.theme?.contentBackground || "#017AD5"};}`
        }), l("style", {
            ...
            style: {
                ...
                fontWeight: "bold",
                color: "#07D5F9",
                backgroundColor: "linear-gradient(45deg, #038FF9, #00C5FF)",
                border: "none",
                fontSize: "2rem",
                cursor: "move"
            },
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Zephware</span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
            ...
            inputs: [{
                ...
                options: [{
                    ...
                    value: {
                        ...
                        infoColor: "linear-gradient(135deg, #2C2A2A, #171212)",
                        cheatList: "linear-gradient(135deg, #2C2A2A, #171212)",
                        defaultButton: "linear-gradient(135deg, #2C2A2A, #171212)",
                        ...
                        textColor: "white",
                        inputColor: "linear-gradient(135deg, #2C2A2A, #171212)",
                        contentBackground: "linear-gradient(135deg, #2C2A2A, #171212)"
                    }
                }, {
                    name: "Blacket",
                    value: {
