javascript: (function() {
    ...
    title.innerText = 'Welcome to ZephWare';

    var description1 = document.createElement('div');
    description1.style.position = 'absolute';
    description1.style.left = '50%';
    description1.style.top = '170px';
    description1.style.transform = 'translateX(-50%)';
    description1.style.fontSize = '18px';
    description1.style.fontWeight = 'bold';
    description1.style.color = '#0766FF';
    description1.innerText = 'the best bookmark cheat hub';

    var description2 = document.createElement('div');
    description2.style.position = 'absolute';
    description2.style.left = '50%';
    description2.style.top = '340px';
    description2.style.transform = 'translateX(-50%)';
    description2.style.fontSize = '18px';
    description2.style.fontWeight = 'bold';
    description2.style.color = '#3D3636';
    description2.innerText = '(click anywhere to continue)';

    guiDiv.appendChild(title);
    guiDiv.appendChild(description1);
    guiDiv.appendChild(description2);

    guiDiv.addEventListener('click', function() {
        document.body.removeChild(guiDiv);
